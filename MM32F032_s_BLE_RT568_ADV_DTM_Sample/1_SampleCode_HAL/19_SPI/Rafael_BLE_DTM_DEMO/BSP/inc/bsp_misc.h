...
EXTERN void TIMER_DisableInt(TIM_TypeDef* TIMx) ;
EXTERN void TIMER_EnableInt(TIM_TypeDef* TIMx) ;
EXTERN void TIMER_Stop(TIM_TypeDef* TIMx) ;
EXTERN void TIMER_Start(TIM_TypeDef* TIMx) ;
EXTERN void TIMER_Open(TIM_TypeDef* TIMx, uint32_t u32Mode, uint32_t u32Freq) ;
