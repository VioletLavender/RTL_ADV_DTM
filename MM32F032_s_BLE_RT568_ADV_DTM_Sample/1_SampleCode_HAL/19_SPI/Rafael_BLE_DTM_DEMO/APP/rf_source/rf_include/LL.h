...
#define LL_PARA_MIN_SCN_WINDOW          ((_TICK_BASE_MULTIPLIER_<<2)+LL_TMR_TICKS_RSV_WAKEUP+LL_TMR_TICKS_RSV_RF_INIT)  //HCI__027
#define LL_PARA_MAX_SCN_WINDOW          65535                       //HCI__027
#define LL_PARA_MIN_INIT_WINDOW         ((_TICK_BASE_MULTIPLIER_<<2)+LL_TMR_TICKS_RSV_WAKEUP+LL_TMR_TICKS_RSV_RF_INIT)  //LL__003
